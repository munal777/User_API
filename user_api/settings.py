...
SECRET_KEY = 'django-insecure-xq7q8z858z8yv-ai3m5h)@31)aau4h2#)_##@d1jme_i-osock'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'social_django.context_processors.login_redirect',  # Required for social auth
            ],
        },
    },
]
...
AUTHENTICATION_BACKENDS = (
    # 'social_core.backends.google.GoogleOAuth2',  # Add other social providers as needed
